  ...
  upload(req, res, async (err) => {
    ...
    try {
      ...
      const [result] = await connection.execute(
        `INSERT INTO items (
                    firebase_uid, name, quantity, code, brand, merek_barang, image_url, barcode_image_url
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
        [firebase_uid, name, quantity, code, brand, merek_barang, imageUrl, barcodeImageUrl]
      );
